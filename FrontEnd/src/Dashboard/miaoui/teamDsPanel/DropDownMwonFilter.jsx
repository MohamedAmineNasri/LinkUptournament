...
const DropDownMwonFilter = ({ orderSelected }) => {
  //drop down logic
    ...
    <div className="relative flex">
      ...
      >
        ...
        <button
          ...
          onClick={() => orderSelected("highest")}
        >
          <FontAwesomeIcon icon={faArrowUp} /> highest
        </button>
        {/* Z---->A */}
        <button
          className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4"
          onClick={() => orderSelected("lowest")}
        >
          <FontAwesomeIcon icon={faArrowDown} /> lowest
        </button>
      </div>
    </div>
  );
...
export default DropDownMwonFilter;
