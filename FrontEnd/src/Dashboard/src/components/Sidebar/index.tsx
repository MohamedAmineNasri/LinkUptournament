...
import { fetchAcademybyManagerId } from "../../../../redux/slice/academySlice.js"
...
//Checked if User have an academy already-----------------------------------------------------------------------.
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("/manage/participant") &&
...
{userRole.includes('Admin') && (
                  <li>
                    <NavLink
                      to="/dashboardAdmin/AddAchivementDS"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                        pathname.includes('') && 'bg-graydark dark:bg-meta-4'
                      }`}
                    >
...
{userRole.includes('Admin') && (
                  <li>
                    <NavLink
                      to="/dashboardAdmin/achievementDS"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                        pathname.includes('') && 'bg-graydark dark:bg-meta-4'
                      }`}
                    >
