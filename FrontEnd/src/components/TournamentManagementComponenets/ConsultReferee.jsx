        ...
        <div className="w-full p-4 rounded-md border border-strokedark bg-[#2d3b4c] ">
          <div class="divide-y divide-dashed">
            <div className="flex py-5 ">
              <span className="flex-1 text-white font-bold">Country</span>
              <span className="flex-1 text-bodygray">
                {referee.country}
              </span>
            </div>
            <div className="flex py-5">
              <span className="flex-1 text-white font-bold">Location</span>
              <span className="flex-1 text-bodygray">{referee.location}</span>
            </div>
            <div className="flex py-5">
              <span className="flex-1 text-white font-bold">Availability</span>
              <span className="flex-1 text-bodygray">
                {referee.availability}
              </span>
            </div>
            <div className="flex py-5">
              <span className="flex-1 text-white font-bold">Role</span>
