  ...
  useEffect(() => {
    const fetchTournaments = async () => {
      try {
        ...
        console.log(
          "Successfully retrieved the tournament:",
          response.data.tournament.type
        );
  ...
  return (
    <>
      ...
      <Modal
        show={show}
        onHide={handleClose}
        className="w-full  mx-auto bg-gray-900"
      >
        ...
        <Modal.Body className="bg-gray-900 text-white">
          <Form>
            <Form.Group className="mb-3" controlId="locationInput">
              ...
              />
              {!isValid1 && (
                <p className="text-red-500">Date must be greater than today.</p>
              )}
              ...
              {!isValid && (
                <p className="text-red-500">
                  Match type must contain only letters.
                </p>
              )}
