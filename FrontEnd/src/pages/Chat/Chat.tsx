      ...
      <main className="flex-grow container mx-auto space-y-12">
        <div>
          <div className="px-4 md:px-8">
            <h1 className="text-3xl font-bold text-left mb-6 mb-1.5 text-2xl font-semibold text-black dark:text-white">
              Browse ChatRooms :
            </h1>
          </div>
        </div>
          ...
          <div>
            {activeTab === "Ongoing" && (
              <div>
                ...
                <Challenges status="Ongoing" searchQuery={searchQuery} />
              </div>
            )}
            {activeTab === "Completed" && (
              <div>
                <h1 className="text-xl font-bold my-4">Completed Challenges</h1>{" "}
