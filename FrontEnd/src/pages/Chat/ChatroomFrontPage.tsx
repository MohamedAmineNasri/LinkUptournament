...
import EmojiPicker from 'emoji-picker-react';
    ...
    const closeRightSide = () => {
        ...
        <div className={`app-container ${darkMode ? 'dark' : ''}`} style={{ marginTop: '90px' }}>
            ...
            <div className={`right-side ${rightSideVisible ? 'show' : ''}`} style={{ margin: 'auto', flexBasis: '50%' }}>
    ...
    <button className="mode-switch" onClick={toggleDarkMode} style={{
        zIndex: 1,
        position: 'relative',
...
export default ChatroomFrontPage;