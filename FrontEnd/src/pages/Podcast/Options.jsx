...
const Options = ({ children }) => {
  const { me, callAccepted, name, setName, callEnded, leaveCall, callUser,setStream  } = useContext(SocketContext);
    ...
    <>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Button variant="contained" color={screenSharing ? "secondary" : "primary"} fullWidth onClick={handleScreenShare} startIcon={screenSharing ? <StopScreenShare fontSize="large" /> : <ScreenShare fontSize="large" />}>
