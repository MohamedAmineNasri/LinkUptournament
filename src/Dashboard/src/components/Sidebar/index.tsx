...
import Logo from "../../../../../public/assets/images/logo_vector.svg";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ...
      style={{ borderRight: "1px solid #2B9451" }}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        >
          ...
          <div className="hidden md:block text-white text-sm font-extrabold">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/manage/participant/team"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("participant") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    viewBox="0 0 23 23"
              ...
              <li>
                <NavLink
                  to="/manage/format"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("format") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    viewBox="0 0 23 23"
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("general") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    viewBox="0 0 23 23"
