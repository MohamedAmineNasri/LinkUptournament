...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (errRef.current) {
        // Check if errRef is defined before accessing its current property
  ...
  return (
    <AuthLayout>
      ...
      <div className="rounded-sm border border-stroke bg-white text-black dark:text-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">
                Start your tournament for free
              </span>
