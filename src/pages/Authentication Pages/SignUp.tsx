        ...
        return (
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default text-black dark:text-white dark:border-strokedark dark:bg-boxdark">
                <div className="flex flex-wrap items-center">
                <div className="hidden w-full xl:block xl:w-1/2">
                    <div className="py-17.5 px-26 text-center">
                    <Link className="mb-5.5 inline-block text-black dark:text-white" to="/">
                        {/* <img className="hidden dark:block" src={Logo} alt="Logo" />
                        <img className="dark:hidden" src={LogoDark} alt="Logo" /> */}
                        LinkUptournament Logo
                    </Link>
            ...
            <div className="form-group">
                <label className="mb-2.5 block font-medium text-black dark:text-white">Account Image:</label>
                <input
                    type="file"
                    className="form-control"
